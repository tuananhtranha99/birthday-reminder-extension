...
(function (a, b) {
  ...
  function c(a) {
    for (var c, d = 1; d < arguments.length; d++)
      (c = null == arguments[d] ? {} : arguments[d]),
        d % 2
  ...
  function k(a) {
    ...
    var b = c(c({}, m), a),
      ...
      e = i(
        ...
        b.offsetTop || m.offsetTop,
        b.offsetBottom || m.offsetBottom,
        b.offsetLeft || m.offsetLeft,
        b.offsetRight || m.offsetRight
      );
    if (b.single)
      for (var f = e.lastElementChild; f; )
        e.removeChild(f), (f = e.lastElementChild);
  ...
  var l = {
    ...
    p = function (a, b, c, d, e) {
      return "top-left" === a
        ? "left:"
            .concat(d, ";top:")
            .concat(b, ";text-align:left;align-items:flex-start;")
        : "top-right" === a
        ? "right:"
            .concat(e, ";top:")
            .concat(b, ";text-align:right;align-items:flex-end;")
        : "top-center" === a
        ? "top:".concat(
            b,
        ...
        ? "left:"
            .concat(d, ";bottom:")
            .concat(c, ";text-align:left;align-items:flex-start;")
        : "bottom-right" === a
        ? "right:"
            .concat(e, ";bottom:")
            .concat(c, ";text-align:right;align-items:flex-end;")
        : "bottom-center" === a
        ? "bottom:".concat(
            c,
            ";left:0;right:0;text-align:center;align-items:center;"
    ...
    q = /*#__PURE__*/ (function () {
      function a(b) {
        ...
        d(this, a),
          ...
          (this.dismissible = b.dismissible),
          (this.closeOnClick = b.closeOnClick),
          (this.message = b.message),
          (this.duration = b.duration),
          (this.pauseOnHover = b.pauseOnHover),
          (this.offsetTop = b.offsetTop),
          (this.offsetBottom = b.offsetBottom),
          (this.offsetLeft = b.offsetLeft),
          (this.offsetRight = b.offsetRight),
          (this.extraClasses = b.extraClasses);
        var e =
            "width:auto;pointer-events:auto;display:inline-flex;white-space:pre-wrap;opacity:".concat(
              this.opacity,
              ";"
            ),
          f = ["notification", this.extraClasses];
        if (
          (this.type && f.push(this.type), this.animate && this.animate["in"])
        ) {
          var g = "animate__".concat(this.animate["in"]),
            i = this.animate.speed
              ? "animate__".concat(this.animate.speed)
              : "animate__faster";
          f.push("animate__animated ".concat(g, " ").concat(i)),
            ...
            value: function () {
              ...
              this.animate && this.animate.out
                ? (this.element.classList.add(
                  ...
                  this.onAnimationEnd(function () {
                    a.removeParent(a.element.parentNode),
                      a.element.remove(),
                      delete n.position;
                  }))
